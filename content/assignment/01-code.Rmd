...
Tanto la preparación como el análisis (que son parte del concepto más general de procesamiento) quedan registrados en un documento de código, en este caso de código R (por lo general, un archivo con extensión .R).
...
<div style="width: 100%; height: 600px; overflow: hidden;">
<video  style="width: 100%;" controls>
<source src="https://www.dropbox.com/s/ima158qslox5h9c/practica1.mp4?raw=1" type="video/mp4">
</video>
</div>
...
Para el procesamiento de cada variables se seguirá el siguiente flujo de trabajo:
...
proc_elsoc$mesfuerzo <- set_label(x = proc_elsoc$mesfuerzo,label = "Recompenda: esfuerzo")

get_label(proc_elsoc$mtalento)
proc_elsoc$mtalento  <- set_label(x = proc_elsoc$mtalento, label = "Recompenda: talento")
```
