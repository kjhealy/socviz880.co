...
Tanto el procesamiento como el análisis quedan registrados en un documento de código, en este caso de código R (por lo general, un archivo con extensión .R).

El documento de **código de procesamiento** posee 5 partes, más una sección de identificación inicial:
...
# Procesamiento de datos ELSOC 2016
