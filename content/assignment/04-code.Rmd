...
- o también vía consola con el comando `setwd(ruta-hacia-la-carpeta-local)`
...
También es posible generar una tabla más resumida en formato publicable y visible en RStudio:
...
Completar el reporte de progreso [aquí](https://forms.gle/dY98zd6C8ZND7ANZ9).
