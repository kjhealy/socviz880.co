...
### ¿Porqué se alteran los coeficientes de correlación?
...
Como podemos ver el efecto que tiene $hsGPA$ sobre $colGPA$, controlando por $ACT$, es mucho mayor que el que tiene $ACT$ parcializado por $colGPA$. Sin embargo, esto nada nos dice de a qué variable poner ojo: **el centro está en las hipótesis que queremos probar con nuestros modelos**.
