...
Visualmente lo podemos ver en el siguiente gráfico usando la librería [`coefplot`](https://www.jaredlander.com/tag/coefplot/).
...
coefplot::multiplot(reg100, reg1500,reg2000,reg2500,
                    shorten = T, innerCI = 0,intercept = F,
                    names = c("n=100","n=1500","n=2000","n=2500"),
