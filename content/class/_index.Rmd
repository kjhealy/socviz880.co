...
Los reportes consisten en completar una encuesta simple y breve, donde se preguntará por el cumplimiento de los objetivos de las prácticas respectivas. La idea es que los puedan completar durante la semana en que se desarrolla la guía, a más tardar el día viernes.
...
- documentar e informar la versión de R con la que estamos trabajando, y también la de las librerías. Las instrucciones de cómo hacer esto aparecen al final de la [Práctica 2](/assignment/02-code)

Y al momento de hacer consultas sobre problemas en la ejecución del código, adjuntar archivo con:

1. Código completo hasta que se produce el problema
2. Indicar línea del código
3. Adjuntar el resultado del output de la información de la sesión (`sessionInfo()`)

### Tutorial de instalación de R {#installR}

- Para quienes no trabajan en R constantemente, abajo un primer tutorial  sobre instalación de R y RStudio, necesarios para poder desarrollar esta práctica:
