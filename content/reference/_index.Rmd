...
- **Informe 1** (individual): Correlación y regresión simple (20%).
- **Informe 2** (grupal): Regresión multiple e inferencia estadística (30%)
- **Informe 3** (grupal): Regresión logística, predictores categóricos y supuestos (50%)
...
Este trabajo abarca la primera parte del curso hasta regresión simple (Sesión 4: Regresión simple 2). Este trabajo consiste en un informe breve, consistente en preparación y análisis de datos incluyendo como producto final la estimación e interpretación de una regresión simple. Para ello, los pasos son los siguientes:
...
## Comentarios generales trabajo 1

- En general muy buenos informes, sobre todo considerando que no contempla solo regresión, sino también un reporte completo de investigación con todas sus secciones.

- La pauta y ejemplo son una referencia, en algunos casos el apego estricto a la pauta o ejemplo no se adecuaba bien a los temas y datos utilizados

  - Ej: uso de scatterplot (nube de puntos) para variables categóricas, en ocasiones no es informativo.

- Entonces, criterio general para la presentación de resultados: ¿es informativo / ilustrativo?, recordar siempre el énfasis comunicacional del informe, pensar en la audiencia.

- En general los tamaños de los betas son pequeños, R2s también, lo que es esperable sobre todo en trabajos iniciales. Ahora, si esto es relevante o significativo es otra pregunta, tiene relación con la literatura y con inferencia estadística.

- Como referencia a los análisis, siempre tener como antecedentes temas de variabilidad / covariabilidad de las variables. Si hay poca varianza, es poco lo que se puede esperar.

- Mayor cuestionamiento y propuestas de formas de medición de las variables

- En ocasiones se recomienda recodificar las variables para favorecer la interpretación. Por ejemplo, que el mayor valor de la variable exprese la mayor presencia del atributo. Esto sucede a menudo en escalas likert donde 1 es totalmente de acuerdo, se recomienda recodificación inversa (reverse coding).
...
Recomendamos utilizar alguna de las siguientes fuentes de datos para realizar los trabajos:
...
- **Informe 3 (final)**: Su formato es de artículo/ reporte breve de investigación. En esta entrega se corrigen aspectos del **Informe 2**, junto con profundizar en el chequeo de supuestos, casos influyentes e interacciones (total máximo 3.500 palabras).
...
En la sección de tareas de UCursos. Para la **Entrega 1** y **Entrega 2** se debe adjuntar un archivo comprimido con los siguientes elementos:
