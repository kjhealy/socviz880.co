...
<br>
<br>
## Sesión 9: Regresión Logística (1)
...
- Se calcula el error estándar del $\beta$, que equivala la diferencia de los promedios de Y por los valores de X
...
- Si $t$ > $t_{crítico}$ = se rechaza $H_0$ con una probabilidad de error p<0.05.

---
# Ejemplo:

- ver interpretación paso a paso de tabla de regresión en [Práctica 8](https://multivariada.netlify.app/assignment/08-code/) 
...
## Se logra mediante una _transformación_ de la(s) variable(s) independientes a coeficientes *LOGIT*
]
