...
* Bajo el supuesto que $\bar{x}$ sigue una **distribución normal**,

* Un mayor $N$ permite que $\bar{x}$ vaya aproximándose valor de $\mu$ debido a la disminución del **error**. 

.center[Por esta razón podemos decir que (...)]
...
- para t serecomienda solo para  N > 30
